...
export default function Store({
  ...
  const storeApps = apps?.sort((a, b) => (a.id === a.store?.appId ? -1 : 1))
  ...
  console.log(`🚀 ~ file: Store.tsx:246 ~ store?.app:`, store?.app)
                    ...
                    <div className={styles.features}>
                      ...
                      <ul>
                        ...
                        <li className={styles.feature}>
                          <A href={getAppSlug(selectedApp)} className={"link"}>
