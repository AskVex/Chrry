...
export default function ImageComponent(props: {
  ...
  if (app?.onlyAgent && !app.image) {
    return app.defaultModel === "deepSeek" ? (
      <DeepSeek color="var(--accent-6)" size={finalSize} />
    ) : app.defaultModel === "chatGPT" ? (
      <OpenAI color="var(--accent-6)" size={finalSize} />
    ) : app.defaultModel === "claude" ? (
      <Claude color="var(--accent-6)" size={finalSize} />
    ) : app.defaultModel === "gemini" ? (
      <Gemini color="var(--accent-6)" size={finalSize} />
    ) : app.defaultModel === "flux" ? (
      <Flux color="var(--accent-6)" size={finalSize} />
    ) : app.defaultModel === "perplexity" ? (
      <Perplexity color="var(--accent-6)" size={finalSize} />
    ) : null
  }
